...
export const Search = () => {
  ...
  const showLoading = useMemo(() => {
    return (
      isFetching && !dynamicResults.length && !filteredStaticResults.length
    );
          ...
          return (
            <CommandGroup key={group.title} heading={group.title}>
              ...
              {group.hasMore && area === "all" && (
                ...
                >
                  <div className="flex items-center gap-x-3 text-ui-fg-muted">
                    <Plus />
  ...
  return (
    <RadixDialog.Root {...props}>
      <RadixDialog.Portal>
        ...
        <RadixDialog.Content
          className={clx(
            "fixed left-[50%] top-[50%] flex max-h-[calc(100%-16px)] w-[calc(100%-16px)] min-w-0 max-w-2xl translate-x-[-50%] translate-y-[-50%] flex-col overflow-hidden rounded-xl bg-ui-bg-base p-0 shadow-elevation-modal",
            {
        ...
        >
          ...
          <div className="flex items-center justify-end border-t bg-ui-bg-field px-4 py-3 text-ui-fg-subtle">
            <div className="flex items-center gap-x-3">
              ...
              <div className="h-3 w-px bg-ui-border-strong" />
              <div className="flex items-center gap-x-2">
                <Text size="xsmall" leading="compact">
      ...
      <div className="flex flex-col border-b">
        <div className="px-4 pt-4">
          <DropdownMenu dir={direction}>
            <DropdownMenu.Trigger asChild>
              <Badge
                size="2xsmall"
                className="cursor-pointer transition-fg hover:bg-ui-bg-base-pressed"
              >
        ...
        <div className="relative flex items-center gap-x-2 px-4 py-3">
          ...
          <Command.Input
            ...
            className={clx(
              "flex !h-6 w-full rounded-md bg-transparent text-sm outline-none placeholder:text-ui-fg-muted disabled:cursor-not-allowed disabled:opacity-50",
              className,
            )}
            {...props}
          />
...
>((props, ref) => {
  ...
  return (
    <Command.Empty ref={ref} className="py-6 text-center text-sm" {...props}>
      <div className="flex min-h-[236px] flex-col items-center justify-center gap-y-3 text-ui-fg-subtle">
...
>((props, ref) => {
  return (
    <Command.Loading
      ref={ref}
      {...props}
      className="flex flex-col bg-ui-bg-base"
    >
...
>(({ className, ...props }, ref) => (
  <Command.Group
    ref={ref}
    className={clx(
      "overflow-hidden text-ui-fg-base [&_[cmdk-group-heading]]:txt-compact-xsmall-plus [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:pb-1 [&_[cmdk-group-heading]]:pt-3 [&_[cmdk-group-heading]]:text-ui-fg-muted [&_[cmdk-item]]:py-2",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <Command.Item
    ref={ref}
    className={clx(
      "txt-compact-small relative flex cursor-pointer select-none items-center gap-x-3 rounded-md p-2 outline-none focus-visible:bg-ui-bg-base-hover aria-selected:bg-ui-bg-base-hover data-[disabled]:pointer-events-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 [&>svg]:text-ui-fg-subtle",
      className,
    )}
    {...props}
  />
